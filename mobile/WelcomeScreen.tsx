  ...
  return (
    <View style={styles.content}>
      <View style={styles.textWrapperWelcome}>
        <Text style={[styles.massiveText, { color: theme.text }]}>Welcome</Text>
        <TouchableOpacity
          style={styles.getStartedBtn}
          activeOpacity={0.7}
          onPress={onNext}
        >
          <Text style={[styles.getStartedText, { color: theme.primaryBlue }]}>
            Lets get started
          </Text>
          <RightArrowIcon width={18} height={18} fill={theme.primaryBlue} />
        </TouchableOpacity>
      </View>
