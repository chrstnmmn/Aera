...
const QuickActionCard: React.FC<Props> = ({
	...
	const isPowerVisible =
		state === "power_enabled" || state === "power_disabled";
	...
	// NEW: Animate the border radius from 20 (closed) to 10 (open)
			...
			<Animated.View
				style={[
					styles.mainCard,
					{
						...
						// Apply the animated border radii directly here
			...
			>
				...
				>
					...
					<View style={styles.statsContainer}>
						...
						<Text
							style={[styles.subtitleText, { color: textColor }]}
						>
							{subtitle}
						</Text>
					</View>
...
const styles = StyleSheet.create({
	...
	mainCard: {
		...
		// REMOVED static right radii here since they are now animated inline
		overflow: "hidden",
		elevation: 8,
		shadowColor: "#000",
	},
